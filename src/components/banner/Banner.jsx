    ...
    <>
      ...
      >
        <div className="relative">
          ...
          <div>
            <div className="flex flex-col text-left -mt-12 wrapper max-w-2xl">
              <p className="text-2xl font-normal text-white">
                Namaste, welcome to Krishi Mart.
              </p>
              <h1 className="text-4xl font-bold text-white">
                <span className="text-yellow-200">Farmer’s Eqipments & Land Leaseing </span> at
              ...
              <div className="flex items-center">
                <button
                  ...
                  className="shadow-md bg-sky-600 mr-3 tooltip bg-[#219653] hover:bg-[#64a55a] text-white font-semibold text-lg w-[200px] py-2 px-2 rounded"
                >
                  Book Now
                </button>
                <i
                  onClick={SpeechRecognition.startListening}
                  className="text-sky-600 tooltip cursor-pointer text-2xl mr-5 fa-solid fa-microphone "
                >
