...
const Profile = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        Object.keys(formData).forEach(key => {
            if (key !== 'email') { // Email typically can't be changed without verification
        ...
        <div className="min-h-screen bg-gradient-to-br from-green-50 to-green-100 px-4 py-12">
            <div className="-4xl mx-auto">
                ...
                >
                    ...
                    {message && (
                        <div
                            className={`mx-8 mt-6 p-4 rounded-lg ${status === 'success' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'
                                }`}
                        >
                            {message}
                        </div>
                                ...
                                <div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <Input
                                            ...
                                            disabled={true} // Email typically can't be changed without verification
                                        />
